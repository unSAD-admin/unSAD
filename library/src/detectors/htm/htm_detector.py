...
class HTMAnomalyDetector(BaseDetector):
    ...
    def initialize(
            self,
            lower_data_limit=-1e9,
            upper_data_limit=1e9,
        ...
        self.htm = HTMApiProvider(docker_path=docker_path,
        ...
        self.detector_key = \
            self.htm.create_new_detector(lower_data_limit,
                                         upper_data_limit,
                                         probation_number,
                                         spatial_tolerance)
    ...
    def train(self, training_data):
        ...
        return self.htm.pass_block_record_to_detector(self.detector_key,
                                                      ts, vs)
